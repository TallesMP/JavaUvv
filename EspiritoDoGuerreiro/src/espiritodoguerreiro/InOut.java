...
public class InOut {
    ...
    public static boolean leBoolean (String cabecalho, String frase) {
                boolean num = false;
                int a = JOptionPane.showConfirmDialog(null, frase, cabecalho, JOptionPane.YES_NO_OPTION);
	...
	public static int duasOpcoes (String cabecalho, String frase, String[] array) {
	...
	public static int contarPalavras (String input) {
		if (input == null || input.isEmpty()) {
			return 0;
		}

		String[] contagem = input.split("\\s+");
